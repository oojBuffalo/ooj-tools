...
| [`ooj-skills`](plugins/ooj-skills/) | Every loose skill that doesn't warrant a plugin of its own, in one bundle. Currently: conventional-commits, a concise reference for writing Conventional Commits messages — pure skills, no hooks or scripts. |
